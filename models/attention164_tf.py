...
# Residual Attention Network — Attention-164 (ImageNet version)
class ResidualAttentionModel164(keras.Model):
    ...
    def __init__(self, num_classes=1000, att_type="arl", **kwargs):
        ...
        # Attention: 4 trunk blocks + mask depth 2
        self.att1 = AttentionModule(block, in_ch, trunk_blocks=4, mask_depth=2, att_type=att_type)
        ...
        # Attention: 7 trunk blocks + mask depth 1
        self.att2 = AttentionModule(block, in_ch, trunk_blocks=7, mask_depth=1, att_type=att_type)
        ...
        # Attention: 4 trunk blocks + mask depth 1
        self.att3 = AttentionModule(block, in_ch, trunk_blocks=4, mask_depth=1, att_type=att_type)
