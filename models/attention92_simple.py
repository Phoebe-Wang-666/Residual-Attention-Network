...
class ResidualAttentionModel92_simple(keras.Model):
    """
    Architecture:
    ...
    def __init__(self, num_classes=1000, att_type="arl", **kwargs):
        ...
        # 2 attention modules
        self.att2 = AttentionModule(block, in_ch, trunk_blocks=3, mask_depth=1, att_type=att_type)
...
if __name__ == "__main__":
    model = ResidualAttentionModel92_simple(num_classes=1000)
